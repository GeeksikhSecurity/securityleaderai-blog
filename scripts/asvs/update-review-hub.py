...
NUM = {8:'Eight',9:'Nine',10:'Ten',11:'Eleven',12:'Twelve',13:'Thirteen',14:'Fourteen',15:'Fifteen'}
...
m_ = m_.replace('Phase B chapters (V6 Authentication, V8 Authorization) are actively translating now and ready for in-progress review.',
                f'{len(done_req)} security-requirement chapters (V1–V9 and V12) are now bilingual and ready for review; {", ".join(remaining)} are next.')
